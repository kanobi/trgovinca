"""
Django settings for trgovinca project.
"""
...
ROOT_URLCONF = 'trgovinca.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'trgovinca.wsgi.application'
...
LOGGING = {
    ...
    'handlers': {
        ...
        'default': {
            'level': 'DEBUG',
            'class': 'trgovinca.lib.colorstreamhandler.ColorStreamHandler',
        },
        'console_dev': {
            'level': 'DEBUG',
